<nav class="w3-sidenav w3-collapse w3-large w3-card-12 w3-animate-right text-right" style="display: none;z-index:200;width:230px;background: #00669b;">
   <header  class="w3-container w3-xlarge" style="background:#0069b; font-weight:bold;">
   <p class="w3-text-white w3-center" style="padding-top:10px; font-size:12px;color: #fff;background:transparent;opacity: .8;"><?php echo ' مرحبا بك :  ' . $_SESSION['fullname']; ?>  <a href="javascript:void(0)" onClick="w3_close()" class="w3-hide-large w3-closen  w3-left" style="padding-top:0;">x</a></p></header>

  <a class=" w3-text-white w3-padding-right"  href="dashboard2.php" style="background:transparent;border: none;outline: none;opacity: .8;padding: 10px;">
 الرئيسي
  </a>
    <style>
        .back_text{
    ...
    <a href="add_patient.php?do=addpatient&id=<?php echo $_SESSION['ID'] ?>" class="back_text w3-padding-right">اضافة مريض جديد
    </a>
  ...
  <a href="xray_a.php?do=manage&id=<?php echo $_SESSION['ID'] ?>?status=<?php echo $_SESSION['status'] ?>" class="back_text w3-padding-right"> الاشعة الغير جاهزة
    <?php
    $status = 1 ;
