...
//$z=$_SESSION['loginfild'];
//unset($z);
$x2= 0;
$nonavsid ='';
$page_title ='Login |  patient';
...
elseif ($do == 'mmm') {
  ...
  //{
  //  $xx = time() - $_SESSION['looked'];
  //  if ($xx > 10) {
    //unset($_SESSION['looked']);
  //  unset($_SESSION['loginfild']);
  //  }
  //}
  if ($_SERVER['REQUEST_METHOD'] =='POST')
  {
      ...
      $stmt = $con->prepare("SELECT
                patientid ,username , password,patientname,imagepatient
                     FROM
                    patient
                     WHERE
                    username=?
      ...
      if ($count > 0)
      {
         ...
         $_SESSION['username'] = $username;
          $_SESSION['IDD'] = $row['patientid'];
          $_SESSION['patientname'] = $row['patientname'];
          $_SESSION['imagepatient'] = $row['imagepatient'];
