<nav class="w3-sidenav w3-collapse w3-large w3-card-12 w3-animate-right text-right" style="display: none;z-index:200;width:230px;background: #00669b;">
   ...
   <p class="w3-text-white w3-center" style="padding-top:10px; font-size:12px;color: #fff;background:transparent;opacity: .8;"><?php echo 'مرحبا بك دكتور :  ' . $_SESSION['doctorname']; ?>  <a href="javascript:void(0)" onClick="w3_close()" class="w3-hide-large w3-closen w3-left" style="padding-top:0;">X</a></p></header>
 ...
 الرئيسي
  ...
  <a href="view_patient.php?do=manage&id=<?php echo $_SESSION['ID'] ?>" class="back_text w3-padding-right">المرضى
  </a>
  <a href="add_test.php?do=editdoctor" class="back_text w3-padding-right">بياناتي الشخصية
  </a>
  <a href="add_test.php?do=appointment&id=<?php echo $_SESSION['ID'] ?>" class="back_text w3-padding-right"> المواعيد
  </a>
  <a href="view_patient.php?do=searchpatient&id=<?php echo $_SESSION['ID'] ?>" class="back_text w3-padding-right"> بحث عن مريض
  </a>
...
<?php
echo  "<img src='..\imagedoctor\\".$_SESSION['imagedoctor']."'  width='55px' height='55px' style='border-radius:50px;margin:-5px -10px 0px -10px;'>" ;
?>
  </button>
	<div dir="ltr">
  <span id="Demo" class=" w3-dropdown-content w3-card-4 w3-animate-zoom" dir="rtl" style="background:#00669b;border-radius:10px; font-weight:bolder;z-index: 1;">
    ...
    <a href="add_test.php?do=editdoctor" class="zead" style="">تعديل البيانات</a>
